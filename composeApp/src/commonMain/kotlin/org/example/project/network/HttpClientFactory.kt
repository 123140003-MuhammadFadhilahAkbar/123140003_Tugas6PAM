...
// ================================================================
// HttpClientFactory.kt — Ktor Client Setup untuk NewsAPI
//
// Perbedaan vs JSONPlaceholder:
//   • defaultRequest: tambahkan header "X-Api-Key" otomatis
//   • Setiap request ke NewsAPI butuh API key di header
// ================================================================
